...
function [bhat,f,f2,CI,r2,knots,x,y]=rcspline(x,y,knots,bootsams,atwhich,plots_data,plots_spline,color)
...
elseif plots_spline==2
    ...
    plot(atwhich,low,'--k', 'color', color);plot(atwhich,upp,'--k', 'color', color);
    % legend('spline', '95% CIs')
    hold off
